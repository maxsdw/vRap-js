 ...
 * Released under the MIT license
 */
vRap.Actions.define("Base.primitives.View",function(){var a;return a=vRap.Locale.alertMessages,{extend:"Base.primitives.Foundation",properties:{type:"view"},reactElements:{},_boot:function(){var b,c,d=this,e=new $.Deferred;return b=d.properties.domEl,b?b instanceof jQuery&&0!==b.length||(vRap.Msg.alert(a.badDomEl+" | "+d._objectNamespace),e.reject()):(b=d.properties.domEl=$('<div id="'+d.properties.id+'"></div>'),c=d.properties.insertTo?$(d.properties.insertTo.selector):$("body"),c instanceof jQuery&&c.length>0?c.append(b):(vRap.Msg.alert(a.badInsertEl+" | "+d._objectNamespace),e.reject())),"rejected"!==e.state()&&(d.properties.style&&b.attr("class",d.properties.style),$.when(d._setTemplate(),d._setReactComponents,d._setModel(),d._setEvents()).done(function(){e.resolve()})),e.promise()},_setTemplate:function(){var a=this,b=new $.Deferred;return a.config.template?$.get(a.config.template,function(c){a.properties.template=$(c).html(),b.resolve()}):b.resolve(),b.promise()},_setReactComponents:function(){var a=this,b=vRap.Query.getApp(vRap.Properties.activeApp),c=new $.Deferred;a.config.components&&"array"===$.type(a.config.components)&&$.each(a.config.components,function(c,d){a.reactElements[d.reactClass]=React.createElement(b.reactCmpts[d.reactClass],$.extend(d.objProps,{locale:b.localeObj}),d.children)}),c.resolve()},_setModel:function(){var a=this,b=new $.Deferred;a.properties.model&&"string"===$.type(a.properties.model)&&(a.linked.model=vRap.Query.getObj(a.properties.model),a.linked.model&&(a.linked.model.subscribe(function(b,c){"dataChange"===b&&a.refresh&&a.refresh(c)}),delete a.properties.model)),b.resolve()},_setEvents:function(){var a=this,b=new $.Deferred;a.config.events&&!$.isEmptyObject(a.config.events)&&$.each(a.config.events,function(b,c){var d,e;d=b.substr(0,b.indexOf(" ")),e=b.substr(b.indexOf(" ")+1),a.properties.domEl.on(d,e,function(b){a[c]($(this),c,b)})}),b.resolve()},emit:function(a,b){var c=this;c.publish(a,b)}}}(),{});
